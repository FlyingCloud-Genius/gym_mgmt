...
import com.gym.management.exception.file.FileNameLengthLimitExceededException;
import com.gym.management.exception.file.FileSizeLimitExceededException;
import com.gym.management.exception.file.InvalidExtensionException;
import com.gym.management.utils.DateUtils;
import com.gym.management.utils.Md5Utils;
...
public class FileUploadUtils {
     ...
     */
    public static final String upload(String baseDir, MultipartFile file, String[] allowedExtension, String provideFileName)
        ...
        String fileName = StringUtils.isEmpty(provideFileName) ? extractFilename(file) : provideFileName;
