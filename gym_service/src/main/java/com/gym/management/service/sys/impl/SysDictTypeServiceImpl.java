...
import com.gym.management.service.sys.ISysDictTypeService;
import com.gym.management.domain.sys.SysDictType;
    ...
    public int deleteDictTypeByIds(String ids) throws BusinessException {
        ...
        for (Long dictId : dictIds) {
            ...
            if (dictDataMapper.countDictDataByType(dictType.getDictType()) > 0) {
                throw new BusinessException(MessageUtils.message("dept.noDelete"));
            }
        }
